...
import { serviceCapabilities, transportSymbol, NotImplementedError } from '@libp2p/interface'
...
export class TCP implements Transport<TCPDialEvents> {
  ...
  constructor () {
    throw new NotImplementedError('TCP connections are not possible in browsers')
  }
